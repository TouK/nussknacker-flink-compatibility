...
class JobManagerContainer private(underlying: GenericContainer, network: Network) extends GenericContainer(underlying) {
...
class TaskManagerContainer private(underlying: GenericContainer, network: Network) extends GenericContainer(underlying) {
