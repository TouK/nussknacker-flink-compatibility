...
/*
  ...
  - add `parseProcessedJson` to handle null handling in union for Flink 1.9
 */
trait BaseGenericITSpec extends FunSuiteLike with Matchers with KafkaSpec with EitherValues with LazyLogging {
