...
// Copied entirely from nussknacker-flink-kafka-components because this module cannot depend on it, but need to provide
// backwards compatible AvroSerializersRegistrar.
